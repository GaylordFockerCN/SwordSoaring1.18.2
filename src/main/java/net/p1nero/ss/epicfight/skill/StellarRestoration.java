...
//                    System.out.println("Released");
    ...
    public static void summonSword(ServerPlayer player, SSPlayer ssPlayer){
        ...
        player.level.playSound(null, sword.getOnPos(), EpicFightSounds.ENTITY_MOVE, SoundSource.BLOCKS, 1,1);
        player.getLevel().addFreshEntity(sword);
    }
    ...
    public void drawOnGui(BattleModeGui gui, SkillContainer container, PoseStack poseStack, float x, float y) {
        ...
        GuiComponent.drawString(poseStack ,gui.font, String.format("%.1f", (ssPlayer.stellarRestorationCooldownTimer / 40.0)), (int) (x + 4), (int) (y + 6), 16777215);
    }
